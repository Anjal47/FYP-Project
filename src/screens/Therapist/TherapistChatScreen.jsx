// src/screens/therapist/TherapistChatScreen.jsx
 ...
 */
export default function TherapistChatScreen({ navigation, route }) {
  const { appointmentId, clientName } = route.params || {};
        ...
        <View style={[styles.bubbleWrap, isMe ? styles.wrapMe : styles.wrapOther]}>
          ...
          <View
            style={[
              ...
              item?.pending ? { opacity: 0.65 } : null,
            ]}
          >
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: UI.bg }]}>
      {/* Header */}
      <View style={[styles.header, { borderBottomColor: UI.line, backgroundColor: UI.card }]}>
      ...
      {loading ? (
        <View style={styles.loadingWrap}>
          ...
          <Text style={[styles.loadingTxt, { color: UI.mut }]}>Opening chat…</Text>
        </View>
      ) : (
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
          ...
          {/* Input Bar */}
          <View style={[styles.inputBar, { backgroundColor: UI.card, borderTopColor: UI.line }]}>
            <TextInput
              value={text}
              onChangeText={setText}
              placeholder="Type a message…"
              placeholderTextColor="#9A9A9A"
              style={[styles.input, { borderColor: UI.line }]}
              multiline
            />
...
const styles = StyleSheet.create({
  ...
  loadingTxt: { marginTop: 10, fontWeight: "800" },
